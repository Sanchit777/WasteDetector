              ...
              <div className="container">
                <div className="hero-inner">
                  <div className="hero-copy">
                    <h1 className="hero-title mt-0">AveryMeet - Effortless Meeting Recordings & Summaries</h1>
                    <p className="hero-paragraph">
                    AveryMeet works seamlessly across all devices, providing automatic meeting recordings and easy access to summaries. Set it up once, and enjoy a streamlined experience for all your meetings, forever.
                    </p>
                ...
                <div className="features-inner section-inner">
                  <div className="features-header text-center">
                    <div className="container-sm">
                      <h2 className="section-title mt-0">AveryMeet</h2>
                  ...
                  <div className="features-wrap">
                    <div className="feature text-center is-revealing">
                      <div className="feature-inner">
                        ...
                        <h4 className="feature-title h3-mobile mb-8">Automated Recordings</h4>
                        <p className="text-sm">
                        No need to worry about manually recording meetings. AveryMeet automatically captures everything for you.
                        </p>
                      </div>
                    </div>
                    <div className="feature text-center is-revealing">
                      <div className="feature-inner">
                        ...
                        <h4 className="feature-title h3-mobile mb-8">AI-Powered Summaries</h4>
                        <p className="text-sm">
                        Get concise, accurate summaries generated instantly after your meeting, so you can quickly catch up or review.
                        </p>
                      </div>
                    </div>
                    <div className="feature text-center is-revealing">
                      <div className="feature-inner">
                        ...
                        <h4 className="feature-title h3-mobile mb-8">Multi-Platform Support</h4>
                        <p className="text-sm">
                        Whether you're on desktop, mobile, or tablet, AveryMeet works seamlessly across all devices.
                        </p>
                      </div>
                    </div>
                    <div className="feature text-center is-revealing">
                      <div className="feature-inner">
                        ...
                        <h4 className="feature-title h3-mobile mb-8">Easy Sharing & Access</h4>
                        <p className="text-sm">
                        Share meeting recordings and summaries with your team effortlessly, and access past meetings anytime from the cloud.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="testimonials-wrap">
                      ...
                      <div className="testimonial-inner">
                        <div className="testimonial-main">
                          <div className="testimonial-header">
                            <img className="mb-16" src="src\pages\home\testimonial-03.png" alt="Testimonial" />
                          </div>
                          <div className="testimonial-body">
                            <p className="mb-0">
                            We no longer worry about taking notes or missing important details. The AI-powered summaries are a game changer! Our team stays aligned, and sharing recordings has never been easier.
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="testimonial text-xs is-revealing">
                      <div className="testimonial-inner">
                        <div className="testimonial-main">
                          <div className="testimonial-header">
                            <img className="mb-16" src="src\pages\home\testimonial-02.png" alt="Testimonial" />
                          </div>
                          <div className="testimonial-body">
                            <p className="mb-0">
                            Using AveryMeet has saved us hours every week. Meetings are automatically recorded and summarized, and I can easily catch up on anything I missed. It's the best tool for busy professionals!
                            </p>
                          </div>
                        </div>
                        <div className="testimonial-footer">
                    ...
                    <div className="testimonial text-xs is-revealing">
                      <div className="testimonial-inner">
                        <div className="testimonial-main">
                          <div className="testimonial-header">
                            <img className="mb-16" src="src\pages\home\testimonial-01.png" alt="Testimonial" />
                          </div>
                          <div className="testimonial-body">
                            <p className="mb-0">
                            AveryMeet ensures that no one is left out. Whether we’re on different time zones or someone couldn’t attend a meeting, the automatic recordings and detailed summaries keep everyone on the same page.
                            </p>
                          </div>
                        </div>
                        <div className="testimonial-footer">
              ...
              <div className="container-sm">
                <div className="newsletter-inner section-inner">
                  <div className="newsletter-header text-center">
                    ...
                    <p className="section-paragraph">
                    Stay updated with the latest features and enhancements of AveryMeet! Join our community of users who are transforming their meeting experiences.
          ...
          <footer className="site-footer">
            <div className="container">
              <div className="site-footer-inner has-top-divider">
                ...
                <div className="footer-copyright">© 2024 AveryMeet, all rights reserved</div>
              </div>
            </div>
          </footer>
        </div>
